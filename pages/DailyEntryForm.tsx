...
// FIX: Replaced `reduce` with an explicit object to provide a more specific type to useState, resolving a type error when submitting the egg production report.
const initialEggData: Omit<EggProductionReport, 'id' | 'date' | 'flockId'> = {
    starter: emptyEggCategory,
    medium: emptyEggCategory,
    standard: emptyEggCategory,
    jumbo: emptyEggCategory,
    dirty: emptyEggCategory,
    broken: emptyEggCategory,
    liquid: emptyEggCategory,
};
